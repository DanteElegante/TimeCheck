...
class HorasExtraActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_tomar_foto) // Reutilizamos layout
        ...
        // Textos para horas extra
        titleTextView.text = "¿Cubriste horas extra?"
        instructionTextView.text = "Es necesario que tu registro de salida/ termino de turno, lo realices en este apartado para que tus horas extras puedan contarse correctamente."
        openCameraButton.text = "Registrar horas extra"
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == REQUEST_IMAGE_CAPTURE && resultCode == Activity.RESULT_OK) {
            ...
            bitmap?.let {
                ...
                val intent = Intent(this, ConfirmarFotoHorasExtraActivity::class.java)
                intent.putExtra("fotoPath", file.absolutePath)
                intent.putExtra("perfil", perfil)
                intent.putExtra("nombre", nombre)
                intent.putExtra("accion", "horas_extra")  // Indicamos acción
