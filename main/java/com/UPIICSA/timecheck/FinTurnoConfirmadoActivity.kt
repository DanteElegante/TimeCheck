...
class FinTurnoConfirmadoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fin_turno_confirmado)
        ...
        bienvenidaText.text = if (perfil == "supervisor") {
            "Turno finalizado Supervisor"
        } else {
            "Turno finalizado Guardia"
        }

        messageText.text = "Haz finalizado tu jornada laboral."
