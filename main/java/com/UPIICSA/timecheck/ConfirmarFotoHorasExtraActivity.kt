...
class ConfirmarFotoHorasExtraActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        usernameText.text = "Finalizar turno con horas extras: $nombre"
        ...
        changePhotoButton.setOnClickListener {
            val intent = Intent(this, HorasExtraActivity::class.java)
        ...
        confirmPhotoButton.setOnClickListener {
            val intent = Intent(this, InicioConfirmadoHorasExtraActivity::class.java)
            intent.putExtra("perfil", perfil)
            intent.putExtra("nombre", nombre)
            startActivity(intent)
            finish()
